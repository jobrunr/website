...
- {{< badge version="professional" >}}JobRunr Pro{{< /badge >}} [Label configuration](#label-configuration)
- {{< badge version="professional" >}}JobRunr Pro{{< /badge >}} [Reduced database load](#reduced-database-load)
- {{< badge version="enterprise" title="JobRunr Pro Enterprise Plan" >}}JobRunr Pro{{< /badge >}} [Multi-Cluster Dashboard](#multi-cluster-dashboard)
- {{< badge version="enterprise" title="JobRunr Pro Enterprise Plan" >}}JobRunr Pro{{< /badge >}} [Single Sign On Improvements](#single-sign-on-improvements)
- {{< badge version="professional" >}}JobRunr Pro{{< /badge >}} [Database row locking strategy configuration](#database-row-locking-strategy-configuration)
- {{< badge version="professional" >}}JobRunr Pro{{< /badge >}} [Automatic deletion of failed jobs](#automatic-deletion-of-failed-jobs)
- {{< badge version="professional" >}}JobRunr Pro{{< /badge >}} [K8s autoscaling](#k8s-autoscaling)
- {{< badge version="professional" >}}JobRunr Pro{{< /badge >}} [Automatic deletion of batch child jobs via the Dashboard](#automatic-deletion-of-batch-child-jobs-via-the-dashboard)
- {{< badge version="professional" >}}JobRunr Pro{{< /badge >}} [Pause and resume dynamic queues](#pause-and-resume-dynamic-queues)
- {{< badge version="professional" >}}JobRunr Pro{{< /badge >}} [Rate limiting configuration at runtime](#rate-limiting-configuration-at-runtime)
- {{< badge version="professional" >}}JobRunr Pro{{< /badge >}} [Faster processing with SmartQueue](#faster-processing-with-smartqueue)
- {{< badge version="professional" >}}JobRunr Pro{{< /badge >}} [Improvement to saveReplace and createOrReplace()](#improvement-to-savereplace-and-createorreplace)
- {{< badge version="professional" >}}JobRunr Pro{{< /badge >}} [Load license key using properties](#load-license-key-using-properties)
...
{{< badge version="enterprise" >}}JobRunr Pro{{< /badge >}}
...
For more information on SSO and OpenID, please see the [SSO Authentication documentation](/en/documentation/pro/sso-authentication/).
...
## Durable executions with `runStepOnce`
...
### StorageProvider
- The Redis and Elasticsearch StorageProviders were deprecated in v7 and are removed from JobRunr in v8. If you rely on `LettuceStorageProvider`, `JedisStorageProvider` or `ElasticSearchStorageProvider`, you may want to [look into moving to another database]({{< ref "documentation/storage" >}}).
- {{< badge version="professional" >}}JobRunr Pro{{< /badge >}} Column type changes for Oracle, MariaDB, MySQL, and SQL Server.
- {{< badge version="professional" >}}JobRunr Pro{{< /badge >}} `CockroachStorageProvider` requires at least CockroachDB v25.1.
- {{< badge version="professional" >}}JobRunr Pro{{< /badge >}} `Set<String> getDistinctDynamicQueues(StateName... stateNames)`; has been removed from the StorageProvider. Closest alternative method is `DynamicQueueStats getDynamicQueueStats(Function<String, String> toLabel)`.
- {{< badge version="professional" >}}JobRunr Pro{{< /badge >}} Method `List<Job> getJobsToProcess(BackgroundJobServer backgroundJobServer, Optional<String> dynamicQueue, AmountRequest amountRequest)` becomes `List<Job> getJobsToProcess(BackgroundJobServer backgroundJobServer, DynamicQueueRequest dynamicQueueRequest, AmountRequest amountRequest)`, expecting a `DynamicQueueRequest` as second parameter.
- {{< badge version="professional" >}}JobRunr Pro{{< /badge >}} Removed `StorageProvider#getRecurringJobIdsOfJobsWithState(StateName... states)`; use `StorageProvider#getRecurringJobIdsOfJobs(JobSearchRequest jobSearchRequest)` instead.
...
- {{< badge version="professional" >}}JobRunr Pro{{< /badge >}}  `StorageProvider.getDistinctRecurringJobSignatures()` now requires a `RecurringJobSearchRequest` as a single argument.
...
- {{< badge version="professional" >}}JobRunr Pro{{< /badge >}} `JobBuilder`: method `runAfter(...)` is replaced by `runAfterSuccessOf(...)`
...
- {{< badge version="professional" >}}JobRunr Pro{{< /badge >}} A triggered recurring job on the dashboard, won't prevent JobRunr from scheduling new ones.
...
### Kotlin Support
- {{< badge version="professional" >}}JobRunr Pro{{< /badge >}} The Exposed Transaction Support package name change: from `org.jobrunr.exposed.transaction.sql` to `org.jobrunr.kotlin.storage.sql.exposed`
