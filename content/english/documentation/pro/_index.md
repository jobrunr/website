...
- __[Built-in Observability]({{< ref "observability.md" >}}):__ keep track on how your jobs are doing over time. Correlate failures easily thanks to built-in observability using your existing observability provider like [Jaeger](https://www.jaegertracing.io/) or [New Relic](https://newrelic.com/).
...
- __[Instant job processing]({{< ref "instant-job-processing.md" >}}):__ Are you in a hurry? JobRunr Pro starts processing your enqueued jobs instantly.
