...
description: "An in-depth guide on how to switch from Quartz Scheduler to JobRunr"
image: /blog/2023-02-20-from-quartz-to-jobrunr.png
...
- **Support for multiple SQL and NoSQL databases:** JobRunr supports [multiple databases]({{< ref "documentation/storage" >}}), including PostgreSQL, MySQL, MariaDB, Oracle and SQL Server, as well as NoSQL databases like MongoDB.
